...
class AppState extends ChangeNotifier {
  ...
  StoredAccount _accountFromJson(Map<String, dynamic> json) {
  return StoredAccount.fromJson(json);
}
 ...
 void signUp(StoredAccount account) {
  ...
  unawaited(_saveAccounts());

  notifyListeners();
}
StoredAccount? signIn(String email, String password) {
  try {
    final account = storedAccounts.firstWhere(
      (a) =>
