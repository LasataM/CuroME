...
class _CaregiverVisitNotesTabState
  ...
  Widget build(BuildContext context) {
    ...
    if (!doctors.any((d) => d.email == _selectedDoctorEmail)) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      initialValue: _selectedDoctorEmail,
                      isExpanded: true,
                      decoration: const InputDecoration(
                      ...
                      items: doctors
                          .map(
                            (doctor) => DropdownMenuItem<String>(
                              value: doctor.email,
                              child: Text(
                                state.doctorDisplayNameForAccount(
                                  doctor,
                                ),
                              ),
                            ),
                  ...
                  (n) => Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Remove this until VisitNote has doctorEmail
                        // Text(
